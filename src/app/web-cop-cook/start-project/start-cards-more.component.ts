...
export class StartCardsMoreComponent implements OnInit {
    cardItems: any[] = [
        {id: 1, name: 'Rack-1', count: 1, city: '上海', area: '浦东'},
        {id: 2, name: 'Rack-2', count: 2, city: '上海', area: '徐汇'},
        {id: 3, name: 'Rack-3', count: 3, city: '上海', area: '陆家嘴'},
        {id: 4, name: 'Rack-4', count: 4, city: '上海', area: '张江'},
        {id: 5, name: 'Rack-5', count: 5, city: '杭州', area: '西湖'},
        {id: 6, name: 'Rack-6', count: 6, city: '杭州', area: '滨江'},
        {id: 7, name: 'Rack-7', count: 5, city: '杭州', area: '下沙'}
    ];
    constructor() { }
