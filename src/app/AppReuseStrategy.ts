...
export class AppRoutingCache implements RouteReuseStrategy {
    ...
    shouldAttach(route: ActivatedRouteSnapshot): boolean {
        ...
        return (route.data.keepParent || !route.routeConfig.children && !route.routeConfig.loadChildren) && !!AppRoutingCache.handlers[this.getRouteUrl(route)];
    }
    ...
    retrieve(route: ActivatedRouteSnapshot): DetachedRouteHandle {
        ...
        console.debug('diffUrl======>', this.getRouteUrl(route));
        if ((!route.data.keepParent && (route.routeConfig.children || route.routeConfig.loadChildren)) || !AppRoutingCache.handlers[this.getRouteUrl(route)]) {
            return null;
        }
